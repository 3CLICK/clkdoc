...
<div class="row" id="DocBannerHolder">
    ...
    <div class="col-xs-4">
      ...
      <div className="card">
        <img className="card-img-left col-xs-8" src="https://images8.alphacoders.com/712/712496.jpg" alt="image" style={{width: 150, height: 150}} /> 
        <div className="container">
      ...
      {/* <div className="card-body align-right col-xs-4">
          <span className="fa fa-star" />
          <span className="fa fa-star" />
          <span className="fa fa-star" />
          <span className="fa fa-star" />
