    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
        ...
        <div class="carousel-inner jumbotron" width="460" height="345">
          ...
          <div class="item active">
            <div class="card col-xs-3" style="width:20rem;margin:20px 0 24px 0">
              <img class="card-img-top" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Ski_trail_rating_symbol-blue_square.svg/600px-Ski_trail_rating_symbol-blue_square.svg.png" alt="image" style="width:50%">
              <div class="card-body">
